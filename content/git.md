...
Multiple checkouts of one repo at once — a second working directory on its own branch, sharing the same history. The key to running parallel Claude agents without their edits colliding. See [[worktrees|Worktrees]].
