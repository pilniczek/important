...
Now `git pull` = `fetch` + `rebase`. Your local commits are replayed on top of the new upstream tip. Linear history, no junk merges. Matches the team's [[strategy|Strategy]].
